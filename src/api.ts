...
class JbcoinAPI extends EventEmitter {
  _feeCushion: number
  _maxFeeJBC: string

  // New in > 0.21.0
  // non-validated ledger versions are allowed, and passed to jbcoind as-is.
  ...
  jbcToDrops = jbcToDrops
  dropsToJbc = dropsToJbc
  iso8601ToJbcoinTime = iso8601ToJbcoinTime
  txFlags = txFlags
