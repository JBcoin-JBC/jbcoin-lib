...
import {Path, GetPaths, JbcoindPathsResponse} from '../pathfind-types'
...
function parseAlternative(sourceAddress: string, destinationAddress: string,
  destinationAmount: JbcoindAmount, alternative: any
): Path {
...
function parsePathfind(pathfindResult: JbcoindPathsResponse): GetPaths {
