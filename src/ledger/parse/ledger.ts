...
import {removeUndefined, jbcoinTimeToISO8601} from '../../common'
  ...
  return removeUndefined(Object.assign(
    {
      ...
      closeTime: jbcoinTimeToISO8601(ledger.close_time),
      closeTimeResolution: ledger.close_time_resolution,
      closeFlags: ledger.close_flags,
      ledgerHash: ledger.hash || ledger.ledger_hash,
      ledgerVersion: ledgerVersion,
      parentLedgerHash: ledger.parent_hash,
      parentCloseTime: jbcoinTimeToISO8601(ledger.parent_close_time),
