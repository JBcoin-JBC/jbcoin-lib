...
import { Connection, errors, validate, jbcToDrops, dropsToJbc, iso8601ToJbcoinTime } from './common';
...
declare class JbcoinAPI extends EventEmitter {
    _feeCushion: number;
    _maxFeeJBC: string;
     ...
     * general use. Instead, use jbcoind's built-in pagination and make multiple
     * requests as needed.
     */
    ...
    jbcToDrops: typeof jbcToDrops;
    dropsToJbc: typeof dropsToJbc;
    iso8601ToJbcoinTime: typeof iso8601ToJbcoinTime;
    txFlags: {
        Universal: {
