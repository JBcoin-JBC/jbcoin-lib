...
class JbcoinAPIBroadcast extends api_1.JbcoinAPI {
    constructor(servers, options) {
        super(options);
        this.ledgerVersion = undefined;
        const apis = servers.map(server => new api_1.JbcoinAPI(_.assign({}, options, { server })));
        // exposed for testing
        this._apis = apis;
    ...
    getMethodNames() {
        const methodNames = [];
        const jbcoinAPI = this._apis[0];
        for (const name of Object.getOwnPropertyNames(jbcoinAPI)) {
            if (typeof jbcoinAPI[name] === 'function') {
...
exports.JbcoinAPIBroadcast = JbcoinAPIBroadcast;
